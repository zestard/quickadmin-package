var Index = function () {
    ...
    return {
        ...
        initCharts: function () {
            ...
            function showTooltip(title, x, y, contents, dayno) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date">' + title + '<\/div><div class="label label-success">Penetration: ' + x / 10 + '%<\/div><div class="label label-danger">Revenue: &pound;' + y * 230 + '<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 120,
            ...
            function randValue() {
                return (Math.floor(Math.random() * (1 + 15 - 10))) + 6;
            }
                ...
                $("#site_statistics").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showTooltip('June ' + x + '<br/>'+item.series.label + ' ' + y, item.pageX, item.pageY, item.series.label + " of " + x + " = " + y);
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
            ...
            if ($('#kpi_statistics').size() != 0) {

                $('#kpi_statistics_loading').hide();
                $('#kpi_statistics_content').show();
    ...
    $.plot($("#kpi_statistics"), data1, {
        xaxis: {
            min: 1,
            max: 17,
            ticks: [[3,'Canvass Calls'],[6,'CVs Sent'],[9,'New Perm Jobs'],[12,'Client Visits'],[15,'Interviews Arranged']],
        ...
        initChat: function () {
            ...
            var handleClick = function (e) {
                ...
                tpl += '<a href="#" class="name">Sarah Lance</a>&nbsp;';
