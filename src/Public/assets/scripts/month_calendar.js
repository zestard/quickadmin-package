$(document).ready(function () {    
    ...
    $('#show_year_calendar_button').click(function ()
    {
       $.ajax
        ({
            url: public_url + '/vacancy/year_calendar/' + (parseInt($('#current_year').val())),
    ...
    $('.previous_month_button').click(function ()
    {
        if(parseInt($('#current_month').val()) > 1)
        {
            ...
            $.ajax
            ({
                url: public_url + '/vacancy/month_calendar/' + (parseInt($('#current_month').val()) - 1),
                data: 'year=' + (parseInt($('#current_year').val())) +'&iVacancyId=' + $('#iVacancyId').val()+'&controller_name='+$('#controller_name').val()+'&iPersonId='+$('#iPersonId').val(),
                success: function(result)
                {
                    $('#calendar_container').html(result);                
        ...
        else
        {
            ...
            $.ajax
            ({
                url: public_url + '/vacancy/month_calendar/12',
    ...
    {   
        ...
        $.ajax
        ({
            url: public_url + '/vacancy/month_calendar/' + next_month,
            data: 'year=' + year +'&month=' + next_month + '&iVacancyId=' + $('#iVacancyId').val()+'&controller_name='+$('#controller_name').val()+'&iPersonId='+$('#iPersonId').val(),
            success: function(result)
            {
                $('#calendar_container').html(result);
            }
