...
<div class="page-sidebar-wrapper">
  <div class="page-sidebar navbar-collapse collapse"> 
    ...
    <ul class="page-sidebar-menu">
      ...
      <li class="start active "> <a href="<?php echo url('/home'); ?>"> <i class="icon-home"></i> <span class="title">Dashboard</span> <span class="selected"></span> </a> </li>
      ...
      <li> <a href="#"> <i class="icon-users"></i> <span class="title">User</span> <span class="arrow "></span> </a>
        <ul class="sub-menu">
          <li> <a href="<?php echo url('/user'); ?>"> List of User </a> </li>
          <li> <a href="<?php echo url('/user/add_user_detail'); ?>"> Add User </a> </li>
        </ul>
      </li>
